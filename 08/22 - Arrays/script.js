...
function cudradoDePromedios(numeros) {
  const promedio1 =
    (numeros[0][0] + numeros[0][1] + numeros[0][2]) / numeros[0].length;
  const promedio2 =
    (numeros[1][0] + numeros[1][1] + numeros[1][2]) / numeros[0].length;
  const promedio3 =
    (numeros[2][0] + numeros[2][1] + numeros[2][2]) / numeros[0].length;
